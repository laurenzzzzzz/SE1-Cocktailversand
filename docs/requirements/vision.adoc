= Vision: {project-name}
Vorname1 Nachname <email@domain.org>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
Dieses Visions-Dokument bezieht sich auf das System {project-system-name}, das von <Team> entwickelt wird. Das System wird es Barkunden erlauben, Cocktails zu bestellen und liefern zu lassen , um damit von Ferne auf das Barangebot zuzugreifen.
...
|===
| Für | Barbesitzer
| der / die | der Cocktails per Versand verkaufen möchte
| ist das  | {project-name} mittels IT-System
| eine  | Vetriebsmöglichkeit
| der / die | den Vetrieb von Cocktails außerhalb vom Barstandort erlaubt
| anders als | normalen Barverkauf
| kann unser Produkt | Fernbestellungen ermöglichen.
|===
...
| Barbetreiber
| Betreibt Verkauf von Cocktails in einer Bar. Möchte Geschäftsfeld durch einen Online-Shop für Cocktailversand erweitern.
| Auftraggeber, liefert Anforderungen und Vorstellungen über System. Trifft Finale Entscheidungen.

| Barmitarbeiter
| Zubereitung Verkauf und perspektivisch Versand von Cocktails.
| Zubereitung und Vesand der bestellen Cocktails. Ordnungsgemäßge Bedienung des Systems.

| Barkunde
| Bestellt und Bezahlt Cocktails (Vorort oder Bestellung).
| Nutzer des Systems und interaktion mit diesem. Zusammenstellung und Bestellung der Cocktails.

| IT-Consulting
| Realisierung der Vorstellungen von Barbetreiber. Entwicklung & Betreuung des IT-Systems
| Entwicklung, Wartung und Support des Online-Bestellsystems
